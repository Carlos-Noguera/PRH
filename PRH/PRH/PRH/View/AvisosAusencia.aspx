<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="AvisosAusencia.aspx.vb" Inherits="PRH.Solicitudes" %>
                                ...
                                <br />
                                    ...
                                    <div class="form-row"> 
                                        ...
                                        <div class="col-sm-12	col-md-4	col-lg-4	col-xl-4">
                                            <asp:DropDownList ID="DdlMotivo" runat="server" AppendDataBoundItems="true" CssClass="form-control" Height="40px" BorderWidth="1px" BorderStyle="Ridge">
                                               
                                       
                                                <asp:ListItem>-- Selecciona un motivo --</asp:ListItem>
                                   ...
                                   <div class="form-row"> 
                                    ...
                                    <div class="col-sm-12	col-md-5	col-lg-5	col-xl-5">
                                        <asp:DropDownList ID="DdlCondiciones" runat="server" AppendDataBoundItems="true" CssClass="form-control" Height="40px" BorderWidth="1px" BorderStyle="Ridge">
                                            <asp:ListItem>--Selecciona una condición--</asp:ListItem>
                                               
                                               
                                                <asp:ListItem Text="Con goce de sueldo" Value="CGS"/>

                                            <%--<listitem DataField="Folio" HeaderText="Folio" />--%>
                                                <asp:ListItem Text="Sin goce de sueldo" Value="SGS"/>
